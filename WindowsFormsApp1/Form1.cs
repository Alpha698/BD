...
where DataPar.denNedeli = '" + denned + "' and DataPar.nomerPary = '" + nompar + "' and '" + ned + "' between DataPar.nedStart and DataPar.nedEnd)";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string selectQuery13 = "INSERT INTO DataPar(denNedeli, nomerPary, nedStart, nedEnd) VALUES ('" + denned + "','" + nompar + "','" + nachned + "','" + konned + "')";
           // MySqlCommand da13 = new MySqlCommand(selectQuery13, connection);
           // connection.Open();
           // da13.ExecuteNonQuery();
            //MessageBox.Show("Данные добавлены!");
            ...
            string selectQuery140 = "Select DISTINCT id_data from DataPar where denNedeli='Понедельник' and nomerPary='1' and nedStart='1' and nedEnd ='16'";
            //предмет
            string selectQuery141 = "Select DISTINCT id_Zanatia from Zanatie where Zanatie.nazvanie='" + zan + "'";
            //препод
            string selectQuery142 = "Select DISTINCT id_Prep from Prepodavateli where Prepodavateli.FIOpr='" + prep + "'";
            //аудитория
            string selectQuery143 = "Select DISTINCT id_Aud from Auditorya where  Auditorya.nomer='" + nomay + "'";
            //группа
            string selectQuery144 = "Select DISTINCT id_gr from Grypa where Grypa.name='" + gryp + "' ";
            //направление
            string selectQuery145 = "Select DISTINCT id_nap from Napravlenie where Napravlenie.kafedra='" + kaf + "' ";

            string selectQuery15 = "INSERT INTO Raspis(id_data, id_Zanatia, id_Prep, id_Aud, id_gr, id_nap) VALUES ('" + selectQuery140 + "','" + selectQuery141 + "','" + selectQuery142 + "','" + selectQuery143 + "','" + selectQuery144 + "','" + selectQuery145 + "')";
            MySqlCommand da14 = new MySqlCommand(selectQuery15, connection);
            connection.Open();
            da14.ExecuteNonQuery();
            MessageBox.Show("Занятие добавлено!");
            //если срабативает условие, то эти два под запроса как переменную в запрос на добавление Auditorya.nomer, Grypa.name,  Prepodavateli.FIOpr, Zanatie.nazvanie, Napravlenie.kafedra
        }//Добавить занятие
